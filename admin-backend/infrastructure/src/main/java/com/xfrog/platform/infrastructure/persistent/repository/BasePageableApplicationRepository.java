...
public abstract class BasePageableApplicationRepository<DTO extends IdDTO, PO extends AuditPO, M extends PageableMapper<PO, DTO, QueryDTO>, QueryDTO extends PageQueryDTO>
